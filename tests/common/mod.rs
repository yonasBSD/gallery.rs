// tests/common/mod.rs
// FIXING CRATE REFERENCE FOR INTEGRATION TESTS
use axum::{
    Router,
    body::Body,
    http::{Request, Response},
};
// In integration tests (external to src), we MUST use the crate name: gallery_rs
// Note: Cargo converts hyphens to underscores in crate names
use gallery_rs::{config::Config, service::AppState, service::GalleryService};
...
pub struct TestResponse(Response<axum::body::Body>);
